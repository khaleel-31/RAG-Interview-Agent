...
def evaluator_node(state):
    ...
    # STRICT PROMPT: Added instruction to avoid markdown formatting
    eval_prompt = f"""
    ...
    try:
        ...
        # Robust Extraction: Removes potential backticks if the LLM ignores instructions
        ...
        # UI SAFETY: Ensure feedback is clean text, not a code block
        # We strip any potential quotes or backticks from the LLM's feedback string
